...
#define debug(...) do {                                                             \
    if (LOG_LEVEL == DEBUG) {                                                       \
        emit_log(                                                                   \
            DEBUG_COLOUR, "[DEBUG]", __FILENAME__, __func__, __LINE__, __VA_ARGS__      \
        );                                                                          \
    }                                                                               \
} while (0)
...
#define info(...) do {                                                              \
    if (LOG_LEVEL <= INFO) {                                                        \
        emit_log(                                                                   \
            INFO_COLOUR, "[INFO]", __FILENAME__, __func__, __LINE__, __VA_ARGS__        \
        );                                                                          \
    }                                                                               \
} while (0)
...
#define warning(...) do {                                                           \
    if (LOG_LEVEL <= WARNING) {                                                     \
        emit_log(                                                                   \
            WARNING_COLOUR, "[WARNING]", __FILENAME__, __func__, __LINE__, __VA_ARGS__  \
        );                                                                          \
    }                                                                               \
} while (0)
...
#define error(...) do {                                                             \
    if (LOG_LEVEL <= ERROR) {                                                       \
        emit_log(                                                                   \
            ERROR_COLOUR, "[ERROR]", __FILENAME__, __func__, __LINE__, __VA_ARGS__      \
        );                                                                          \
    }                                                                               \
} while (0)
...
#define critical(...) do {                                                          \
    if (LOG_LEVEL <= CRITICAL) {                                                    \
        emit_log(                                                                   \
            CRITICAL_COLOUR, "[CRITICAL]", __FILENAME__, __func__, __LINE__, __VA_ARGS__\
        );                                                                          \
    }                                                                               \
} while (0)
